...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="dashboard.php" class="logo">PSCHOOL</a>
      ...
      <div class="profile">
         ...
         ?>
            ...
            <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn"><i class="fa-solid fa-right-from-bracket"></i> logout</a>
         <?php
         } else {
         ?>
