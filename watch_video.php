      ...
      ?>
            <div class="video-details">
               ...
               <div class="info">
                  ...
                  <p><i class="fa-solid fa-thumbs-up"></i><span><?= $total_likes; ?> likes</span></p>
               </div>
               <div class="tutor">
               ...
               <form action="" method="post" class="flex">
                  ...
                  ?>
                     <button type="submit" name="like_content"><i class="fa-solid fa-thumbs-up"></i><span>liked</span></button>
                  <?php
                  } else {
                  ?>
                     <button type="submit" name="like_content"><i class="fa-solid fa-thumbs-up"></i><span>like</span></button>
                  <?php
                  }
                  ?>
               </form>
